      ...
      <div className={styles.inner}>
        ...
        <div className={styles.grid}>
          <div ref={r1} className={styles.left}>
            <p>I'm an <strong>energetic and results-driven Software Engineer</strong> based in Chennai, India, with hands-on experience building full-stack web and mobile applications.</p>
