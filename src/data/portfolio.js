...
export const PROJECTS = [
  ...
  {
    emoji: '🕒',
    title: 'AttendTrack — Employee Attendance Management System',
    desc: 'A mobile-first attendance system replacing manual notebook tracking for small office teams — one-tap Present/Absent toggle, a smart dashboard with daily stats, and Excel export as a 12-sheet monthly workbook.',
    tags: ['Next.js', 'Tailwind CSS', 'Supabase'],
    url: null,
    urlLabel: 'Private — Live in Office 🔒',
  },
];
